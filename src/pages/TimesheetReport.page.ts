...
export class TimesheetReportPage {
    ...
    private Elements = {
        ...
        TimesheetReportLabel: "//a[normalize-space()='Timesheet Report']",
        fromDate: "//input[@id='fromDt']",
        toDate: "//input[@id='toDt']",
        downloadButton: "//button[normalize-space()='Timesheet Report']"
    };
    ...
    async goto(): Promise<void> {
        ...
        await this.base.waitAndClick(this.Elements.TimesheetReportLabel);
    }
